...
xx=11.5;
    ...
    do_arc(30.5-xx,30.5, 9,0,360);
    do_arc(30.5-xx,30.5,10,0,360);
    do_arc(30.5-xx,30.5,11,0,360);
    do_arc(30.5-xx,30.5,12,0,360);
    ...
    do_arc(30.5,30.5-xx, 9,0,360);
    do_arc(30.5,30.5-xx,10,0,360);
    do_arc(30.5,30.5-xx,11,0,360);
    do_arc(30.5,30.5-xx,12,0,360);
...
//27.5-16 = 11.5;
    ...
    do_arc(30.5-zz,30.5-zz, 9,0,360);
    do_arc(30.5-zz,30.5-zz,10,0,360);
    do_arc(30.5-zz,30.5-zz,11,0,360);
    do_arc(30.5-zz,30.5-zz,12,0,360);
    do_arc(30.5-zz,30.5+zz, 9,0,360);
    do_arc(30.5-zz,30.5+zz,10,0,360);
    do_arc(30.5-zz,30.5+zz,11,0,360);
    do_arc(30.5-zz,30.5+zz,12,0,360);
