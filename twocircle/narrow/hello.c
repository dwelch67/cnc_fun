...
int main ( void )
{
    ...
    if(1)
    {
        ...
        for(ra=STEP;ra<600;ra+=STEP)
        {
            ...
            if(ra==(STEP*(38+1))) flag++;
            if(ra==(STEP*(39+1))) flag++;
...
//}
    ...
    do_arc(24.5,24.5,3.5,-90,180);
    do_arc(24.5,24.5,4.5,-90,180);
    do_arc(24.5,24.5,5.5,-90,180);
    do_arc(24.5,24.5,6.5,-90,180);
    ...
    do_arc(35.5,35.5,3.5,90,360);
    do_arc(35.5,35.5,4.5,90,360);
    do_arc(35.5,35.5,5.5,90,360);
    do_arc(35.5,35.5,6.5,90,360);

    do_arc(35.5,35.5, 9.5,-90,180);
    do_arc(35.5,35.5,10.5,-90,180);
    do_arc(35.5,35.5,11.5,-90,180);
    do_arc(35.5,35.5,12.5,-90,180);
...
//  do_circle(12.5,12.5,13.5);
    ...
    //do_circle(42.5,48.5,14.5);
    //do_circle(42.5,48.5,11.5);

    //do_circle(48.5,42.5,14.5);
    //do_circle(48.5,42.5,11.5);
