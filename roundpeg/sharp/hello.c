...
//27.5-16 = 11.5;
    ...
    do_arc(30.5-zz,30.5,rr+0,180+45,45);
    do_arc(30.5-zz,30.5,rr+1,180+45,45);
    do_arc(30.5-zz,30.5,rr+2,180+45,45);
    do_arc(30.5-zz,30.5,rr+3,180+45,45);
	
    do_arc(30.5+zz,30.5,rr+0,45,180+45);
    do_arc(30.5+zz,30.5,rr+1,45,180+45);
    do_arc(30.5+zz,30.5,rr+2,45,180+45);
    do_arc(30.5+zz,30.5,rr+3,45,180+45);
	
    do_arc(30.5,30.5-zz,rr+0,45,225);
    do_arc(30.5,30.5-zz,rr+1,45,225);
    do_arc(30.5,30.5-zz,rr+2,45,225);
    do_arc(30.5,30.5-zz,rr+3,45,225);
	
    do_arc(30.5,30.5+zz,rr+0,180+45,90-45);
    do_arc(30.5,30.5+zz,rr+1,180+45,90-45);
    do_arc(30.5,30.5+zz,rr+2,180+45,90-45);
    do_arc(30.5,30.5+zz,rr+3,180+45,90-45);
