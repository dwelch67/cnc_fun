...
if(0)
{
    ...
    do_arc(17.5,11.5,4.5,180,0);
    do_arc(17.5,11.5,5.5,180,0);
    do_arc(17.5,11.5,6.5,180,0);
    do_arc(17.5,11.5,7.5,180,0);
    //do_arc(17.5,11.5,8.5,180+theangle,0-theangle);

    do_arc(23.5,17.5,4.5,270,90);
    do_arc(23.5,17.5,5.5,270,90);
    do_arc(23.5,17.5,6.5,270,90);
    do_arc(23.5,17.5,7.5,270,90);
    //do_arc(23.5,17.5,8.5,270+theangle,90-theangle);

    do_arc(11.5,17.5,4.5,90,270);
    do_arc(11.5,17.5,5.5,90,270);
    do_arc(11.5,17.5,6.5,90,270);
    do_arc(11.5,17.5,7.5,90,270);
    //do_arc(11.5,17.5,8.5,90+theangle,270-theangle);

    do_arc(17.5,23.5,4.5,0,180);
    do_arc(17.5,23.5,5.5,0,180);
    do_arc(17.5,23.5,6.5,0,180);
    do_arc(17.5,23.5,7.5,0,180);
    //do_arc(17.5,23.5,8.5,0+theangle,180-theangle);

    do_arc(23.5,11.5,10.5,90,180);
    do_arc(23.5,11.5,11.5,90,180);
    do_arc(23.5,11.5,12.5,90,180);
    do_arc(23.5,11.5,13.5,90,180);

    do_arc(23.5,23.5,10.5,180,270);
    do_arc(23.5,23.5,11.5,180,270);
    do_arc(23.5,23.5,12.5,180,270);
    do_arc(23.5,23.5,13.5,180,270);

    do_arc(11.5,23.5,10.5,270,0);
    do_arc(11.5,23.5,11.5,270,0);
    do_arc(11.5,23.5,12.5,270,0);
    do_arc(11.5,23.5,13.5,270,0);

    do_arc(11.5,11.5,10.5,0,90);
    do_arc(11.5,11.5,11.5,0,90);
    do_arc(11.5,11.5,12.5,0,90);
    do_arc(11.5,11.5,13.5,0,90);
